...
func schemaToTerraform(ctx context.Context, schema models.CustomRuntimeRuleResourceModel) (ruleAPI.CustomRule, diag.Diagnostics) {
    util.DLog(ctx, "Executing CustomRuleResource.schemaToTerraform")
    ...
    util.DLog(ctx, "Finishing CustomRuleResource.schemaToTerraform execution")

    return resp, diags
}

func terraformToSchema(ctx context.Context, tf ruleAPI.CustomRule) (models.CustomRuntimeRuleResourceModel, diag.Diagnostics) {
    util.DLog(ctx, "Executing CustomRuleResource.terraformToSchema")
    ...
    util.DLog(ctx, "Finishing CustomRuleResource.terraformToSchema execution")

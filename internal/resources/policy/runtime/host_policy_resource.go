...
func RuntimePolicySchemaToTerraform(ctx context.Context, plan *models.RuntimeHostPolicyResourceModel, client *api.PrismaCloudComputeAPIClient) (policyAPI.RuntimeHostPolicy, diag.Diagnostics) {
    util.DLog(ctx, "Executing RuntimePolicySchemaToTerraform")
...
func RuntimePolicyRulesSchemaToTerraform(ctx context.Context, schemaRules []models.RuntimeHostPolicyRuleResourceModel, client *api.PrismaCloudComputeAPIClient, customRuleIdMap map[string]int) ([]policyAPI.RuntimeHostPolicyRule, diag.Diagnostics) {
    ...
    for _, schemaRule := range schemaRules {
        ...
        network, dns, diags := networkingToTerraform(ctx, schemaRule.Networking)
        if diags.HasError() {
            return rules, diags
        }
    ...
    util.DLog(ctx, "Finishing RuntimePolicyRulesSchemaToTerraform execution")
...
func RuntimePolicyTerraformToSchema(ctx context.Context, policy policyAPI.RuntimeHostPolicy, plan models.RuntimeHostPolicyResourceModel, client *api.PrismaCloudComputeAPIClient) (models.RuntimeHostPolicyResourceModel, diag.Diagnostics) {
    ...
    util.DLog(ctx, "Finishing RuntimeHostPolicyTerraformToSchema execution")
...
func antiMalwareToTerraform(ctx context.Context, schemaAntiMalware *models.RuntimeHostPolicyAntiMalwareResourceModel, trackSshEvents bool) (policyAPI.AntiMalware, diag.Diagnostics) {
    var (
        diags diag.Diagnostics
...
func antiMalwareToSchema(ctx context.Context, tfAntiMalware policyAPI.AntiMalware) (models.RuntimeHostPolicyAntiMalwareResourceModel, bool, diag.Diagnostics) {
    var diags diag.Diagnostics
...
func networkingToTerraform(ctx context.Context, schemaNetworking *models.RuntimeHostPolicyNetworkingResourceModel) (policyAPI.Network, policyAPI.DNS, diag.Diagnostics) {
    var (
        diags diag.Diagnostics
    ...
    if schemaNetworking == nil {
        return policyAPI.Network{}, policyAPI.DNS{}, diags
    }
...
func networkingToSchema(ctx context.Context, tfNetwork policyAPI.Network, tfDns policyAPI.DNS) (models.RuntimeHostPolicyNetworkingResourceModel, diag.Diagnostics) {
    var (
        diags diag.Diagnostics

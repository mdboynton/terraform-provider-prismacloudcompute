...
func GetRuntimeServerlessPolicy(ctx context.Context, c api.PrismaCloudComputeAPIClient) (RuntimeServerlessPolicy, error) {
...
func GetRuntimeServerlessPolicyFiltered(ctx context.Context, c api.PrismaCloudComputeAPIClient, ruleNames []string) (RuntimeServerlessPolicy, error) {
	policy, err := GetRuntimeServerlessPolicy(ctx, c)
	if err != nil {
...
func UpsertRuntimeServerlessPolicy(ctx context.Context, c api.PrismaCloudComputeAPIClient, policy RuntimeServerlessPolicy) error {
...
func UpsertRuntimeServerlessPolicyFiltered(ctx context.Context, c api.PrismaCloudComputeAPIClient, policy RuntimeServerlessPolicy, deletedRuleNames []string) error {
	currentPolicy, err := GetRuntimeServerlessPolicy(ctx, c)
	if err != nil {
		return err
	}
